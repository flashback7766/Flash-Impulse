...
case "${SKIP_QUICKSHELL}" in
  true) true;;
  *)
     # Should overwriting the whole directory not only ~/.config/quickshell/flash-impulse/ cuz https://github.com/end-4/dots-hyprland/issues/2294#issuecomment-3448671064
...
install_file "dots/.local/share/icons/flash-impulse.svg" "${XDG_DATA_HOME}"/icons/flash-impulse.svg
install_file "dots/.local/share/icons/flash-impulse.svg" "${XDG_DATA_HOME}"/icons/flash-impulse.svg
