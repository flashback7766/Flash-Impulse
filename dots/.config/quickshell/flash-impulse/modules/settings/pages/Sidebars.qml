...
ContentPage {
    ...
    ContentSection {
        ...
        ContentSubsection {
            ...
            ConfigJsonField {
                title: Translation.tr("Toggle layout")
                tooltip: Translation.tr("A list of { size, type }. size is how many columns the tile spans; type is one of network, bluetooth, idleInhibitor, mic, audio, nightLight.")
                value: Config.options.sidebar.quickToggles.android.toggles
                onEdited: newValue => Config.options.sidebar.quickToggles.android.toggles = newValue
            }
        }
    ...
    ContentSection {
        icon: "neurology"
        title: Translation.tr("AI panel")

        ConfigSwitch {
            buttonIcon: "animation"
            text: Translation.tr("Fade the response in as it streams")
            checked: Config.options.sidebar.ai.textFadeIn
            onCheckedChanged: {
                Config.options.sidebar.ai.textFadeIn = checked;
            }
            StyledToolTip {
                text: Translation.tr("Costs a repaint per token, which is noticeable on a long answer")
            }
        }
    }
}
